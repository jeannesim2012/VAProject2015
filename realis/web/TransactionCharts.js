...
d3.csv('data/REALIS2014.csv', function (transactions) {
    ...
    speedSumGroup = runDimension.group().reduceSum(function(d) {return d.transactedPrice;});
    
    transactionPrice = transaction.dimension(function (d) {
        return (d.transactedPrice);
    });
    
    transPriceHist = transactionPrice.group().reduceCount(function (d) {
        return d.transactedPrice;
    });
